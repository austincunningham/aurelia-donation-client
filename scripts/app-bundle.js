...
define('services/donation-service',['exports', 'aurelia-framework', './fixtures', './messages', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _fixtures, _messages, _aureliaEventAggregator) {
  ...
  var DonationService = (_dec = (0, _aureliaFramework.inject)(_fixtures2.default, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    ...
    DonationService.prototype.newCandidate = function newCandidate(firstName, lastName, office) {
      var cand = {
        firstName: firstName,
        lastName: lastName,
        office: office
    ...
    DonationService.prototype.login = function login(email, password) {
      ...
      for (var i = 0; i < this.users.length; i++) {
        if (email === this.users[i].email && password === this.users[i].password) {
          console.log('authenticate ' + this.users[i].email);
          status.success = true;
...
define('viewmodels/candidate/candidate',['exports', 'aurelia-framework', '../../services/donation-service'], function (exports, _aureliaFramework, _donationService) {
  'use strict';
...
define('viewmodels/signup/signup',['exports', 'aurelia-framework', '../../services/donation-service', '../../services/messages'], function (exports, _aureliaFramework, _donationService, _messages) {
  'use strict';
...
define('viewmodels/candidates/candidate',['exports', 'aurelia-framework', '../../services/donation-service'], function (exports, _aureliaFramework, _donationService) {
  'use strict';
...
define('text!viewmodels/candidates/candidate.html', ['module'], function(module) { module.exports = "<template>\n\n  <form submit.trigger=\"addCandidate()\" class=\"ui form stacked segment\">\n    <h3 class=\"ui dividing header\"> Add a Candidate </h3>\n    <div class=\"field\">\n      <label>First Name </label> <input value.bind=\"firstName\">\n    </div>\n    <div class=\"field\">\n      <label>Last Name </label> <input value.bind=\"lastName\">\n    </div>\n    <div class=\"field\">\n      <label>Office </label> <input value.bind=\"office\">\n    </div>\n    <button class=\"ui blue submit button\">Add</button>\n  </form>\n\n</template>\n"; });
